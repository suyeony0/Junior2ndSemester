	...
	<article id="main">
		...
		<div class="container page-top">
			...
			<div class="row" style="padding-bottom: 30px">
				<c:choose>
					<c:when test="${MY_CAT_LIST.listSize > 0}">
			...
			<div align="right" style="padding-bottom: 30px; padding-top: 30px;">
				<form action="MyCatSearchAction" method="GET" class="col-lg-3 col-md-4 col-xs-6 thumb">
					<select name="WHERE">
						<option value="NAME">냥이 이름</option>
						<option value="COMMENT">코멘트</option>
						<option value="LOCATION">출몰 지역</option>
					</select> 
