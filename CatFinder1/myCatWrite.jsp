...
<script type="text/javascript">
	function HandlePopupResult(result) {
		var authWindow = window.open('/CatFinder1/naverMapTest.jsp',
				'authWindow');
		...
		<div class="inner">
			<form name="BoardWriteForm" method="POST"
				...
				<table class="table table-striped" summary="글쓰기 전체 테이블">
					...
					<tr>
						<td>출몰 지역</td>
						<td><input type="text" name="LOCATION" id="ADD" value=""><br> <input
							type="button" value="주소 찾기" onclick="HandlePopupResult()"></td>
					</tr>
					<tr>
						<td>코멘트</td>
					...
					<tr>
						<td colspan="2"><div align="center">
								<input type="submit" value="등록">&nbsp;&nbsp; <input
									type="button" value="뒤로" onclick="move('MyCatViewAction');">
							</div></td>
					</tr>
				</table>
			</form>
