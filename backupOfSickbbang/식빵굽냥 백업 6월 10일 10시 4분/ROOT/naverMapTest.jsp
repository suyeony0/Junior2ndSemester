...
<body>
   ...
   <a href="#" onclick="CloseMySelf(this);">지번 주소</a>
   <a href="#" onclick="CloseMySelf1(this);">도로명 주소</a>
<div id="map" style="width:500px; height:500px; border-radius: 10px; cursor: pointer; position:relative">
  <div class="search" style="position:absolute; z-index:1">
    ...
    <ul style="position:absolute; z-index:1; padding:30px" >
...
function CloseMySelf(sender){
    try{
        window.opener.HandlePopupResult(saveadd[0]);
   		 }
    catch (err) {}
    window.close();
}
function CloseMySelf1(sender){
    try{
        window.opener.HandlePopupResult(saveadd[1]);
   		 }
    catch (err) {}
    window.close();
}
          ...
          naver.maps.Service.geocode({
              ...
              var htmlAddresses = [],
               ...
               if (item.roadAddress) {
                  ...
                  saveadd[1]=item.roadAddress;
              }

              if (item.jibunAddress) {
                  htmlAddresses.push('[지번 주소] ' + item.jibunAddress);
                  saveadd[0]=item.jibunAddress;
              }
