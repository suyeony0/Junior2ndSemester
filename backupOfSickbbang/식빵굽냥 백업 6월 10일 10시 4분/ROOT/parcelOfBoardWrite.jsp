  		...
  		<!-- Page Wrapper -->
  			<div id="page-wrapper">
  				...
  				<header id="header" class="alt">
  					<h4>
  						<a href="index.html">식빵굽냥></a>
  						<a href="boardElement.html">게시판></a>
  						<a href="parcelOutBoard.html">입양, 분양 게시판</a>
  					</h4>
  					<nav id="nav">
  						<ul>
  							<li class="special">
  								...
  								<div id="menu">
  									<ul>
  										...
  										<li><a href="registAndSearch.html">우리동네 고양이 등록 / 검색</a></li>
  										<li><a href="boardElement.html">게시판</a></li>
  										<li><a href="agreementOfTerms.html">회원가입</a></li>
